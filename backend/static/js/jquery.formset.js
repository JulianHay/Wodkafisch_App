...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                var delButtonHTML = '<button type="button" class="' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText +'</button>';
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<button type="button" class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</button>';
