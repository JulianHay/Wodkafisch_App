...
const SponsorScreen = () => {
  ...
  const renderSponsors = (item) => (
    <View
      key={item.username}
      style={{ flexDirection: "row", marginBottom: 3, left: -15 }}
    >
      <View
        style={{
          width: 125,
      ...
      >
        <CustomText fontSize={16} style={{ left: 0 }}>
          {item.username}:
        </CustomText>
      </View>
      <View
        ...
        {item.season_badges
          ? item.season_badges.map((badge, index) => (
              <Image
                key={badge + index}
                source={{
                  uri: "https://wodkafis.ch/media/" + badge,
                }}
                style={{
                  width: 20,
                  height: 20,
      ...
      <View style={styles.badgeImageContainer}>
        {item.diamond_sponsor !== 0 ? (
          <View style={{ flexDirection: "row" }}>
            <Image
              source={require("../assets/diamond_badge.png")}
            ...
            >
              <CustomText fontSize={8}>
                {item.diamond_sponsor > 1 ? item.diamond_sponsor : ""}
              </CustomText>
            </View>
          </View>
        ) : null}
      ...
      <View style={styles.badgeImageContainer}>
        {item.black_sponsor !== 0 ? (
          <View style={{ flexDirection: "row" }}>
            <Image
              source={require("../assets/black_badge.png")}
              style={styles.badgeImage}
            />
            <View
              style={{
            ...
            >
              <CustomText fontSize={8}>
                {item.black_sponsor > 1 ? item.black_sponsor : ""}
              </CustomText>
            </View>
          </View>
        ) : null}
      ...
      <View style={styles.badgeImageContainer}>
        {item.gold_sponsor !== 0 ? (
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <CustomText fontSize={8}>
                {item.gold_sponsor > 1 ? item.gold_sponsor : ""}
              </CustomText>
            </View>
          </View>
        ) : null}
      ...
      <View style={styles.badgeImageContainer}>
        {item.silver_sponsor !== 0 ? (
          <View style={{ flexDirection: "row" }}>
            <Image
              source={require("../assets/silver_badge.png")}
              style={styles.badgeImage}
            />
            <View
              style={{
            ...
            >
              <CustomText fontSize={8}>
                {item.silver_sponsor > 1 ? item.silver_sponsor : ""}
              </CustomText>
            </View>
          </View>
        ) : null}
      ...
      <View style={styles.badgeImageContainer}>
        {item.bronze_sponsor !== 0 ? (
          <View style={{ flexDirection: "row" }}>
            <Image
              source={require("../assets/bronze_badge.png")}
              style={styles.badgeImage}
            />
            <View
              style={{
            ...
            >
              <CustomText fontSize={8}>
                {item.bronze_sponsor > 1 ? item.bronze_sponsor : ""}
              </CustomText>
            </View>
          </View>
        ) : null}
      ...
      >
        <Container title="Battle Pass">
          ...
          <LinearGradient colors={["#c59c34", "#9a690e"]} style={styles.season}>
            <View>
              <CustomText fontSize={12} color={"#fff"} fontWeight={"bold"}>
                Season {seasonData[0].id}
              </CustomText>
            </View>
          ...
          <View>
            <Image
              source={{
                uri: "https://wodkafis.ch/media/" + seasonData[0].image,
              }}
          ...
          {isPromo ? (
            <View
              style={{ marginTop: 25, marginBottom: -10, flexDirection: "row" }}
            >
          ...
          <View style={{ width: "45%", marginTop: 20, marginBottom: 5 }}>
            <CustomButton
              onPress={() => {
                Linking.openURL("http://paypal.me/wodkafisch");
              }}
              text={"Donate now"}
              fgColor="white"
              bgColor="#000022"
