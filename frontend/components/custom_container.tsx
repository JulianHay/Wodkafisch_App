...
const TouchableContainer = (props) => {
    const { onPress,title,width,bgColor,borderColor,borderRadius,borderWidth,colors,children } = props;
    return (
        <TouchableOpacity
        onPress={onPress}> 
            ...
            style={[
                ...
                {colors ? <LinearGradient colors={colors} 
                style={{borderRadius:7,width:'100%',padding:10,justifyContent:'center',alignItems:'center'}}>{children}</LinearGradient>
                : 
                children}
            </View>
        </TouchableOpacity>
...
const Container = (props) => {
    const { title,width,bgColor,borderColor,borderRadius,borderWidth,colors,children } = props;
    return (
        <View> 
            <View style={styles.text}>
                <CustomText color={darkmode ? 'white' : 'black'} fontWeight='bold'>
